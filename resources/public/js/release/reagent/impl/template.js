...
var temp__5539__auto__ = reagent.impl.template.cache_get(reagent.impl.template.prop_name_cache,cljs.core.name(k));
if((temp__5539__auto__ == null)){
return (reagent.impl.template.prop_name_cache[cljs.core.name(k)] = reagent.impl.util.dash_to_camel(k));
} else {
var k_SINGLEQUOTE_ = temp__5539__auto__;
...
var G__10607 = o;
(G__10607[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__10609__i < G__10609__a.length) {G__10609__a[G__10609__i] = arguments[G__10609__i + 0]; ++G__10609__i;}
  args = new cljs.core.IndexedSeq(G__10609__a,0,null);
} 
...
if(reagent.impl.template.named_QMARK_(k)){
var temp__5539__auto__ = reagent.impl.template.cache_get(reagent.impl.template.custom_prop_name_cache,cljs.core.name(k));
if((temp__5539__auto__ == null)){
...
var G__10611 = o;
(G__10611[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
while (G__10613__i < G__10613__a.length) {G__10613__a[G__10613__i] = arguments[G__10613__i + 0]; ++G__10613__i;}
  args = new cljs.core.IndexedSeq(G__10613__a,0,null);
} 
...
var G__10616 = props;
var G__10616__$1 = ((((!((id == null))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__10616,cljs.core.cst$kw$id,id):G__10616);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__10616__$1,cljs.core.cst$kw$class,(function (){var old_class = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__10617){
var map__10618 = p__10617;
var map__10618__$1 = ((((!((map__10618 == null)))?(((((map__10618.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__10618.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__10618):map__10618);
var props = map__10618__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10618__$1,cljs.core.cst$kw$class);
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,cljs.core.cst$kw$class,clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__10618,map__10618__$1,props,class$){
return (function (c){
...
});})(map__10618,map__10618__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__10620){
var map__10621 = p__10620;
var map__10621__$1 = ((((!((map__10621 == null)))?(((((map__10621.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__10621.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__10621):map__10621);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10621__$1,cljs.core.cst$kw$on_DASH_write);
...
return reagent.impl.batching.do_after_render(((function (node_value,map__10621,map__10621__$1,on_write){
return (function (){
...
});})(node_value,map__10621,map__10621__$1,on_write))
);
} else {
...
var G__10624 = jsprops;
(G__10624["defaultValue"] = value);

(G__10624["onChange"] = ((function (G__10624,v,value,on_change){
return (function (p1__10623_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__10623_SHARP_);
});})(G__10624,v,value,on_change))
);
...
var vec__10627 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10627,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10627,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10627,(2),null);
...
var temp__5539__auto__ = reagent.impl.template.get_key(cljs.core.meta(v));
if((temp__5539__auto__ == null)){
return reagent.impl.template.get_key(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(v,(1),null));
} else {
var k = temp__5539__auto__;
return k;
}
});
...
var jsprops = ({"argv": v});
var temp__5541__auto___10631 = reagent.impl.template.key_from_vec(v);
if((temp__5541__auto___10631 == null)){
} else {
var key_10632 = temp__5541__auto___10631;
(jsprops["key"] = key_10632);
}
...
var temp__5541__auto___10633 = reagent.impl.template.key_from_vec(argv);
if((temp__5541__auto___10633 == null)){
} else {
var key_10634 = temp__5541__auto___10633;
reagent.impl.template.oset(jsprops,"key",key_10634);
}
...
var G__10635 = reagent.impl.template.__GT_NativeWrapper();
(G__10635["name"] = c);
...
var temp__5539__auto__ = reagent.impl.template.cache_get(reagent.impl.template.tag_name_cache,x);
if((temp__5539__auto__ == null)){
return (reagent.impl.template.tag_name_cache[x] = reagent.impl.template.parse_tag(x));
} else {
var s = temp__5539__auto__;
return s;
}
});
...
var G__10636 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__10636) : reagent.impl.template.as_element.call(null,G__10636));
} else {
...
var len__4531__auto___10641 = arguments.length;
var i__4532__auto___10642 = (0);
while(true){
if((i__4532__auto___10642 < len__4531__auto___10641)){
args__4534__auto__.push((arguments[i__4532__auto___10642]));

var G__10643 = (i__4532__auto___10642 + (1));
i__4532__auto___10642 = G__10643;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq10639){
...
break;
default:
var G__10646 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__10646;
continue;
...
var n__4408__auto___10648 = a.length;
var i_10649 = (0);
while(true){
if((i_10649 < n__4408__auto___10648)){
(a[i_10649] = reagent.impl.template.as_element((a[i_10649])));

var G__10650 = (i_10649 + (1));
i_10649 = G__10650;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4408__auto___10651 = a.length;
var i_10652 = (0);
while(true){
if((i_10652 < n__4408__auto___10651)){
var val_10653 = (a[i_10652]);
if(((cljs.core.vector_QMARK_(val_10653)) && ((reagent.impl.template.key_from_vec(val_10653) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_10652] = reagent.impl.template.as_element(val_10653));

var G__10654 = (i_10652 + (1));
i_10652 = G__10654;
continue;
} else {
}
...
var ctx = ({});
var vec__10655 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10655,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10655,(1),null);
...
var G__10658 = (cljs.core.count(argv) - first_child);
switch (G__10658) {
case (0):
...
case (1):
var G__10659 = comp;
var G__10660 = jsprops;
var G__10661 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return (reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3 ? reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3(G__10659,G__10660,G__10661) : reagent.impl.template.global$module$react.createElement.call(null,G__10659,G__10660,G__10661));

break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv(((function (G__10658){
